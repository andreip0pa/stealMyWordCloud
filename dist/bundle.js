...
var url = "https://localhost:44318/api/Word";
document.getElementById("wordButton").addEventListener("click", buttonPress);
getAll();
function buttonPress() {
    var insertWord = (document.getElementById("wordInput")).value;
    _node_modules_axios_index__WEBPACK_IMPORTED_MODULE_0___default.a.put(url + "/9999", {
        text: insertWord,
        count: 0
...
function getAll() {
    _node_modules_axios_index__WEBPACK_IMPORTED_MODULE_0___default.a.get(url).then(function (response) {
        document.getElementById("wordList").innerHTML = "";
        console.log(response.data);
        response.data.forEach(function (element) {
            var size = (element.count * 2) % 200 + 25;
            var biggest = "";
            if (size < 50) {
